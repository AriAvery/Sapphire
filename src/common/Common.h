...
struct LandsetStruct
{
  ...
  uint32_t unknown9;
  uint32_t fcIcon;
  uint32_t fcIconColor;
  uint16_t exteriorRoof;
  uint16_t exteriorWall;
  uint16_t exteriorWindow;
  uint16_t exteriorDoor;
  uint16_t otherFloorWall;
  uint16_t otherFloorFlooring;
  uint16_t basementWald;
  uint16_t gardenSign;
  uint8_t color[8];
};
