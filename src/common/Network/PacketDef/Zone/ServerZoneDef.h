...
struct FFXIVIpcInitUI : FFXIVIpcBasePacket<InitUI>
{
   ...
   unsigned short unknown15C[8];
   unsigned short fishingRecordsFish[26];
   unsigned short fishingRecordsFishWeight[26];
   unsigned short beastExp[11];
   unsigned short unknown1EA;
   unsigned short unknown1EC;
   unsigned short unknown1EE;
   unsigned short unknown1F0;
   unsigned short unknown1F2;
   unsigned char unknownMask1F8[12];
